...
const projects = [
  {
    ...
    description:
      "Built an AI prompt evaluation system that analyzes prompt quality, scores effectiveness, and suggests optimized prompt structures for better LLM responses.",
  ...
  },
  {
    ...
    description:
      "Built an embeddings optimization system that uses hierarchy search and vector search to optimize embeddings for better LLM responses in RAG pipelines.",
  ...
  },
  {
    ...
    description:
      "Built an automated news intelligence pipeline using n8n that collects the latest news across multiple sectors from the internet, summarizes the content using AI, and delivers concise updates directly to a dedicated Gmail inbox. The system runs fully automated workflows for real-time news aggregation, summarization, and distribution.",
